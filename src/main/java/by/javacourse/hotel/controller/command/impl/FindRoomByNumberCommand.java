...
import static by.javacourse.hotel.controller.command.RequestAttribute.VISIBLE_ATR;
import static by.javacourse.hotel.controller.command.RequestParameter.*;
import static by.javacourse.hotel.controller.command.SessionAttribute.CURRENT_PAGE;
import static jakarta.servlet.http.HttpServletResponse.SC_INTERNAL_SERVER_ERROR;

public class FindRoomByNumberCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            List<Room> rooms = service.findRoomByNumber(searchParameters);
