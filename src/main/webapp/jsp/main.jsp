...
<body>
<div class="container text-secondary text-center font-weight-bold">
    <div class="row">
        <div class="col">
            <h1>${message}</h1>
        </div>
    ...
    <div class="row">
        <div class="col">
            <h4><a class="link-secondary text-decoration-none"
                   href="${path}/controller?command=go_to_sing_in_page">${sing_in}</a>
            </h4>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col">
            <h6><a class="link-secondary text-decoration-none"
                   href="${path}/controller?command=change_locale&language=EN">${en}</a> /
                <a class="link-secondary text-decoration-none"
                   href="${path}/controller?command=change_locale&language=RU">${ru}</a></h6>
        </div>
    </div>
